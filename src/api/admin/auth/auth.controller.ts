...
export class AuthController {
    ...
    async verifyEmail(@Query('jwtToken') token: string, @Res() res: Response): Promise<MessageResponseDto> {
    ...
    async signIn(@Body() signInAdminDto: SignInDto, @Res() res: Response): Promise<Response<MessageResponseDto>> {
    ...
    @ApiOkResponse({type: MessageResponseDto})
    async refreshAccesToken(@Req() req: Request, @Res() res: Response): Promise<Response<MessageResponseDto>> {
